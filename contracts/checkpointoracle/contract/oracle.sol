 ...
 * @author Gary Rong<garyrong@metrachain.org>, Martin Swende <martin.swende@metrachain.org>
...
contract CheckpointOracle {
    ...
    */
    ...
    //
    // The default value should be the same as the checkpoint size(32768) in the metrachain.
    uint sectionSize;
