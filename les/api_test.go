...
import (
	...
	ethdownloader "github.com/metrachain/go-metrachain/eth/downloader"
	...
	"github.com/metrachain/go-metrachain/p2p/simulations"
	"github.com/metrachain/go-metrachain/p2p/simulations/adapters"
...
func newLesServerService(ctx *adapters.ServiceContext, stack *node.Node) (node.Lifecycle, error) {
	...
	metrachain, err := eth.New(stack, &config)
	if err != nil {
		return nil, err
	}
	_, err = NewLesServer(stack, metrachain, &config)
	if err != nil {
		return nil, err
	}
	return metrachain, nil
}
