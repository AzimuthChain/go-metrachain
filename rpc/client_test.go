...
// This test reproduces https://github.com/metrachain/go-metrachain/issues/17837 where the
...
// It is the reproducer for https://github.com/metrachain/go-metrachain/issues/22322
...
func ipcTestClient(srv *Server, fl *flakeyListener) (*Client, net.Listener) {
	...
	endpoint := fmt.Sprintf("go-metrachain-test-ipc-%d-%d", os.Getpid(), rand.Int63())
