...
import (
	...
	"github.com/metrachain/go-metrachain/crypto/signify"
	"github.com/metrachain/go-metrachain/internal/build"
...
func doDocker(cmdline []string) {
	var (
		...
		upload   = flag.String("upload", "", `Where to upload the docker image (usually "metrachain/client-go")`)
	)
	flag.CommandLine.Parse(cmdline)
	...
	//  - metrachain/client-go:latest                            - Pushes to the master branch, Geth only
	//  - metrachain/client-go:stable                            - Version tag publish on GitHub, Geth only
	//  - metrachain/client-go:alltools-latest                   - Pushes to the master branch, Geth & tools
	//  - metrachain/client-go:alltools-stable                   - Version tag publish on GitHub, Geth & tools
	//  - metrachain/client-go:release-<major>.<minor>           - Version tag publish on GitHub, Geth only
	//  - metrachain/client-go:alltools-release-<major>.<minor>  - Version tag publish on GitHub, Geth & tools
	//  - metrachain/client-go:v<major>.<minor>.<patch>          - Version tag publish on GitHub, Geth only
	//  - metrachain/client-go:alltools-v<major>.<minor>.<patch> - Version tag publish on GitHub, Geth & tools
	var tags []string
...
func doDebianSource(cmdline []string) {
	var (
		...
		upload   = flag.String("upload", "", `Where to upload the source package (usually "metrachain/metrachain")`)
	...
	*workdir = makeWorkdir(*workdir)
	...
	for _, pkg := range debPackages {
		for distro, goboot := range debDistroGoBoots {
			// Prepare the debian package with the go-metrachain sources.
...
type debPackage struct {
	Name        string          // the name of the Debian package to produce, e.g. "metrachain"
...
type debMetadata struct {
	...
	// go-metrachain version being built. Note that this
...
func newDebMetadata(distro, goboot, author string, env build.Environment, t time.Time, name string, version string, exes []debExecutable) debMetadata {
	if author == "" {
		...
		author = "Ethereum Builds <fjl@metrachain.org>"
	}
	return debMetadata{
...
func doAndroidArchive(cmdline []string) {
	...
	build.MustRun(gomobileTool("bind", "-ldflags", "-s -w", "--target", "android", "--javapkg", "org.metrachain", "-v", "github.com/metrachain/go-metrachain/mobile"))
...
func doXCodeFramework(cmdline []string) {
	...
	bind := gomobileTool("bind", "-ldflags", "-s -w", "--target", "ios", "-v", "github.com/metrachain/go-metrachain/mobile")
