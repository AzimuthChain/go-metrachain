...
func (ec *Client) SyncProgress(ctx context.Context) (*metrachain.SyncProgress, error) {
	var raw json.RawMessage
...
func (ec *Client) SubscribeNewHead(ctx context.Context, ch chan<- *types.Header) (metrachain.Subscription, error) {
...
func (ec *Client) FilterLogs(ctx context.Context, q metrachain.FilterQuery) ([]types.Log, error) {
...
func (ec *Client) SubscribeFilterLogs(ctx context.Context, q metrachain.FilterQuery, ch chan<- types.Log) (metrachain.Subscription, error) {
	arg, err := toFilterArg(q)
	if err != nil {
		return nil, err
	}
...
func toFilterArg(q metrachain.FilterQuery) (interface{}, error) {
...
func (ec *Client) CallContract(ctx context.Context, msg metrachain.CallMsg, blockNumber *big.Int) ([]byte, error) {
...
func (ec *Client) CallContractAtHash(ctx context.Context, msg metrachain.CallMsg, blockHash common.Hash) ([]byte, error) {
	var hex hexutil.Bytes
...
func (ec *Client) PendingCallContract(ctx context.Context, msg metrachain.CallMsg) ([]byte, error) {
	var hex hexutil.Bytes
...
func (ec *Client) EstimateGas(ctx context.Context, msg metrachain.CallMsg) (uint64, error) {
...
func toCallArg(msg metrachain.CallMsg) interface{} {
	arg := map[string]interface{}{
		"from": msg.From,
		"to":   msg.To,
	}
...
func (p *rpcProgress) toSyncProgress() *metrachain.SyncProgress {
	if p == nil {
		return nil
	}
	return &metrachain.SyncProgress{
