...
//
// Detailed usage document and tutorial available on the go-metrachain Wiki page:
// https://github.com/metrachain/go-metrachain/wiki/Native-DApps:-Go-bindings-to-Ethereum-contracts
package bind
