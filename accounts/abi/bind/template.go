...
import "github.com/metrachain/go-metrachain/accounts/abi"
...
import (
	...
	metrachain "github.com/metrachain/go-metrachain"
...
{{range $contract := .Contracts}}
	...
	{{range .Events}}
		...
		type {{$contract.Type}}{{.Normalized.Name}}Iterator struct {
			...
			sub  metrachain.Subscription // Subscription for errors, completion and termination
