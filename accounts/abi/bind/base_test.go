...
func (mt *mockTransactor) EstimateGas(ctx context.Context, call metrachain.CallMsg) (gas uint64, err error) {
	return 0, nil
}
...
func (mc *mockCaller) CallContract(ctx context.Context, call metrachain.CallMsg, blockNumber *big.Int) ([]byte, error) {
...
func (mc *mockCaller) PendingCallContract(ctx context.Context, call metrachain.CallMsg) ([]byte, error) {
