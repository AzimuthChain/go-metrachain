...
func (api *PublicFilterAPI) Logs(ctx context.Context, crit FilterCriteria) (*rpc.Subscription, error) {
	...
	logsSub, err := api.events.SubscribeLogs(metrachain.FilterQuery(crit), matchedLogs)
	if err != nil {
		return nil, err
	}
...
// Same as metrachain.FilterQuery but with UnmarshalJSON() method.
type FilterCriteria metrachain.FilterQuery
...
func (api *PublicFilterAPI) NewFilter(crit FilterCriteria) (rpc.ID, error) {
	...
	logsSub, err := api.events.SubscribeLogs(metrachain.FilterQuery(crit), logs)
	if err != nil {
		return "", err
	}
